    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <div className="creator-info">
          <div className="creator-name">Created by Kowshik Annavarapu</div>
          <a href="mailto:Kowshik.annavarapu2006@gmail.com" className="creator-email">
            Kowshik.annavarapu2006@gmail.com
          </a>
        </div>
      </div>
